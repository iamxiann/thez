...
function Framework.SaveAppearance(appearance, identifier)
    Database.Users.UpdateSkinForUser(identifier, json.encode(appearance))
end

function Framework.GetAppearance(identifier)
    local user = Database.Users.GetSkinByIdentifier(identifier)
    if user then
