...
- Player specific outfit locations (restricted via identifier)
- Makeup Secondary Color
- Blacklist / Limit Components & Props to certain Jobs / Gangs / identifiers / ACEs (Allows you to have VIP clothing on your Server)
- Blacklist / Limit Peds to certain Jobs / Gangs / identifiers / ACEs
