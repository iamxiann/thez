...
Config.SurgeonCost = "tiket_oplas"
Config.SurgeonUseDistance = 3.0
...
---@type string[]
Config.Aces = {"god", "admin", "helper", "trial"} -- list of ace permissions used for blacklisting
...
Config.Stores = {
    ...
    {
        type = "surgeon",
        coords = vector4(-460.03, -1039.7, 24.29, 74.2),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(-457.29, -1037.91, 23.29),
            vector3(-463.25, -1038.12, 23.43),
            vector3(-462.81, -1044.18, 23.29),
            vector3(-457.36, -1043.95, 23.29)
        }
    }
}
...
--[[    {
    ...
    {
        job = "ambulance",
        coords = vector4(-476.30, -1040.68, 24.29, 7.19),
        size = vector3(3, 3, 3),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(-474.83, -1037.11, 23.29),
            vector3(-473.75, -1043.58, 23.29),
            vector3(-478.07, -1043.52, 23.29),
            vector3(-478.43, -1037.14, 23.29)
        },
        identifiers = {
    ...
    {
        job = "resto",
        coords = vector4(-291.97, -90.35, 49.5, 80.24),
        size = vector3(3, 3, 3),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(-293.37, -87.93, 48.5),
            vector3(-294.42, -91.27, 48.61),
            vector3(-290.94, -92.69, 48.5),
            vector3(-289.92, -89.69, 48.5)
        },
        identifiers = {
    ...
    {
        job = "police",
        coords = vector4(463.48, -986.78, 31.83, 1.85),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(461.62, -989.3, 30.83),
            vector3(465.17, -989.42, 30.83),
            vector3(465.2, -984.98, 30.83),
            vector3(461.71, -985.03, 30.83)
        },
        identifiers = {
    ...
    {
        job = "mechanic",
        coords = vector4(-826.27, -417.39, 42.0, 294.45),
        size = vector3(3, 3, 3),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(-828.79, -416.28, 41.0),
            vector3(-827.07, -419.71, 41.0),
            vector3(-822.17, -417.56, 40.97),
            vector3(-823.27, -413.69, 40.97)
        },
        identifiers = {
    ...
    { --akam
        --job = "",
        coords = vector4(-3669.1, 3861.71, 19.95, 94.52),
        size = vector3(3, 3, 3),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(-3668.64, 3860.53, 18.95),
            vector3(-3670.85, 3860.71, 18.95),
            vector3(-3670.54, 3863.9, 18.95),
            vector3(-3668.29, 3863.77, 18.95)
        },
        identifiers = {
    ...
    { -- apartments
        --job = "",
        coords = vector4(-797.71, 328.38, 220.44, 352.01),
        size = vector3(3, 3, 3),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(-799.44, 330.35, 219.44),
            vector3(-796.15, 330.33, 219.44),
            vector3(-796.07, 326.19, 219.44),
            vector3(-799.41, 326.19, 219.44)
        },
        identifiers = {
    ...
    {-- edd house
        --job = "",
        coords = vector4(-1252.8, 789.75, 189.36, 79.84),
        size = vector3(3, 3, 3),
        rotation = 45,
        usePoly = true,
        points = {
            vector3(-1251.17, 787.71, 188.36),
            vector3(-1251.55, 792.1, 188.36),
            vector3(-1255.05, 791.62, 188.36),
            vector3(-1255.38, 787.8, 188.36),
        },
        identifiers = {
