...
Config.TrueZombieModel = 'Emptiness'

Config.FallbackModels = { 'zombie4', 'a_m_m_acult_01', 'a_m_m_afriamer_01' }
...
Config.Sync = {
    Enabled = true,
    ZombieSyncRadius = 100.0,
    MaxGlobalZombies = 75,
    MaxZombiesPerZone = 15,
...
Config.GrabMechanic = {
    ...
    zombieAnim = 'perp_idle',
    playerAnim = 'victim_idle',
    grabDamage = 14,            -- was 8 — +75%
    grabDamageInterval = 900,
    escapeRequired = 10,        -- successful ox_lib skill checks needed to break free
    escapeCooldown = 400,       -- ms to wait before retrying after a failed skill check
    skillCheckDifficulty = 'medium', -- lib.skillCheck difficulty per escape attempt ('easy'/'medium'/'hard', or a table of stages)
