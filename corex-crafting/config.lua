...
Config.Recipes = {
    ...
    },
    {
        ...
        requiresWorkbench = true,
        blueprint = false,
        -- Gated by the Master Crafter capstone (k_master flag).
        -- corex-crafting calls exports['corex-skills']:CanCraftRecipe(src, recipe).
        requiresFlag = 'unlocksRareRecipes',
        label = 'Combat PDW',
    ...
    },
    {
        ...
        requiresWorkbench = true,
        blueprint = false,
        -- Gated by the Weapon Modder skill (k_modder).
        -- Use a string id for a single requirement, or an array of ids.
        requiresSkill = 'k_modder',
        label = 'Up-n-Atomizer',
...
Config.Workbenches = {
    {
        coords = vector3(-1241.4050, 5.2119, 48.1328 ),
        heading = 328.3970,
        zOffset = -1.0, -- optional per-model correction after automatic ground placement
        radius = 2.5,
        model = 'prop_tool_bench02',
        label = 'Crafting Workbench',
        interactLabel = 'Use Workbench',
        icon = 'fa-hammer',
        blip = true
    }
}
